    ...
    return (
         <Form className='p-4 border rounded m-3'>
            <Form.Group controlId='formName'>
                ...
                <Form.Control type='text' name= 'name' placeholder='Ingrese el nombre producto' value={values.name} onChange={handleChange}/>
            </Form.Group>

             <Form.Group controlId='formImage'>
                 <Form.Label>Imagen</Form.Label>
                 <Form.Control type='text' name= 'image' placeholder='Ingrese la imagen del producto' value={values.image} onChange={handleChange}/>
             </Form.Group>
